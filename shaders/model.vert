...
// 4x4 Translation matrix of a 3D mesh:
uniform mat4 translation;

// 4x4 Rotation matrix of a 3D mesh:
uniform mat4 rotation;

// 4x4 Scaling matrix of a 3D mesh:
uniform mat4 scale;


void main()
{
	currPos = vec3(model * translation * -rotation * scale * vec4(aPos, 1.0f));  // Negative rotation is to account for GLM and GLTF using different rotation standards. Change back to positive if buggy
	...
	texCoord = mat2(0.0, -1.0, 1.0, 0.0) * aTex;  // Also change this if rotation glitch
